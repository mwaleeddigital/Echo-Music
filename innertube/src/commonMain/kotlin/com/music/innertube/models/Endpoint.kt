...
@Serializable sealed class Endpoint
...
@Serializable data class FeedbackEndpoint(val feedbackToken: String) : Endpoint()
...
@Serializable
data class ToggledServiceEndpoint(var feedbackEndpoint: FeedbackEndpoint?) : Endpoint()
