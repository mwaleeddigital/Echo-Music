...
/**
 * Two row: a big thumbnail, a title, and a subtitle Used in [GridRenderer] and
 * [MusicCarouselShelfRenderer] Item type: song, video, album, playlist, artist
 */
@Serializable
  ...
  val musicVideoType: String?
    get() =
      thumbnailOverlay
        ...
        ?.musicVideoType ?: navigationEndpoint.musicVideoType
}
