  ...
  data class Contents(
    ...
    data class TwoColumnWatchNextResults(
      ...
      data class Results(
        ...
        @Serializable
        data class Results(
          @SerialName("contents") val content: List<Content?>? = null,
        ) {
          @Serializable
          data class Content(
            ...
            val continuationItemRenderer: ItemSectionRenderer.Content.ContinuationItemRenderer? =
              null,
          ) {
            @Serializable
            data class ItemSectionRenderer(
              @SerialName("contents") val contents: List<Content?>? = null,
              @SerialName("sectionIdentifier") val sectionIdentifier: String? = null,
            ) {
              @Serializable
              data class Content(
                @SerialName("continuationItemRenderer")
                ...
                data class ContinuationItemRenderer(
                  ...
                  data class ContinuationEndpoint(
                    @SerialName("clickTrackingParams") val clickTrackingParams: String? = null,
            ...
            data class VideoPrimaryInfoRenderer(
              ...
              data class ViewCount(
                ...
                data class VideoViewCountRenderer(
                  @SerialName("viewCount") val viewCount: VideoViewCountRenderer.ViewCount? = null,
                ) {
                  @Serializable
                  data class ViewCount(
                    @SerialName("simpleText") val simpleText: String? = null,
                  )
                }
              }
              ...
              data class Owner(
                ...
                data class VideoOwnerRenderer(
                  ...
                  data class Thumbnail(
                    ...
                    val thumbnails: List<com.music.innertube.models.Thumbnail>? = null,
                  )
